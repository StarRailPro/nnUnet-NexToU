...
from nnunetv2.training.nnUNetTrainer.variants.network_architecture.nnformer_src.random_stuff import no_op
from nnunetv2.training.nnUNetTrainer.variants.network_architecture.nnformer_src.to_torch import to_cuda, maybe_to_torch
...
class SegmentationNetwork(NeuralNetwork):
    ...
    def _internal_maybe_mirror_and_pred_3D(self, x: Union[np.ndarray, torch.tensor], mirror_axes: tuple,
                                           ...
                                           mult: np.ndarray | torch.tensor = None) -> torch.tensor:
